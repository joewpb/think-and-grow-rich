...
export const resourceData: Record<string, ResourceItem> = {
  ...
  'Desire statements': {
    ...
    status: 'live',
    href: '/resources/worksheet-desire-statement.md',
  },
  'Affirmation templates': {
    ...
    status: 'live',
    href: '/resources/worksheet-affirmation.md',
  },
  'Progress trackers': {
    ...
    status: 'live',
    href: '/resources/worksheet-progress-tracker.md',
  },
  'Self-analysis questionnaires': {
    ...
    status: 'live',
    href: '/resources/worksheet-self-analysis.md',
  },
  '15-minute chapter recaps': {
    ...
    status: 'live',
    href: 'https://drive.usercontent.google.com/download?id=1m_XYvPcRlCjugHVJ_GOLzX4Yrd0K7SNi&export=download',
  },
  'Guided visualization audio': {
    ...
    status: 'live',
    href: 'https://drive.usercontent.google.com/download?id=1eIcfhqs-sMZPG-gQuFpnYHRWShzEM87v&export=download',
  },
  'Auto-suggestion recordings': {
    ...
    status: 'live',
    href: 'https://drive.usercontent.google.com/download?id=1SZ_oqMEvMfZaFM8sDsIhxFH__zybA1PB&export=download',
  },
}
